...
languages = {
    "ru": {
        ...
        "register_info": f"""<i>Для того чтобы получать прогнозы нужно:</i>

💸1. <i>Зарегистрироваться на сайте 1win через бота, чтобы он мог считывать прогноз.</i>

💸2. <i>При регистрации вводите промокод <code>{PROMO}</code> (копируется при нажатии), бонус от меня, халявные 500% к пополнению.</i>

💸3. <i>После успешной регистрации ваша учетная запись будет добавлена в бота, а ссылка, через которую вы зарегестрировались позволит считывать вероятность выигрыша на вашем аккаунте и давать верный прогноз.</i>

✍🏻4. <i>Если возникли какие-то проблемы, обращайтесь в нашу поддержку:</i> @supporw1n

‼️<i>Если вы не выполните эти шаги, наш бот не сможет добавить ваш аккаунт в свою базу данных, и предоставленные сигналы могут не соответствовать</i>‼️

<b>Поставили - забрали🔥</b>
""",
        "instruction_info": """<b>🍀Бот основан и обучен на кластерной нейронной сети OpenAIPro!</b> 
<b>📈Для обучения бота было сыграно 40 000+ игр 🎰</b>

<b>В настоящее время пользователи бота успешно генерируют 15-25% от своего 💸 капитала ежедневно!</b>

Бот все еще проходит проверки и исправления! Точность бота 92%!
Чтобы достичь максимальной прибыли, следуйте этой инструкции:

💰1. <b>Зарегистрируйтесь в букмекерской конторе. Чтобы это сделать, нужно нажать кнопку «Зарегистрироваться» в боте.‼️Регистрация аккаунта должна происходить строго через бота.</b>
...
💰6. ‼️<b>В течение 4 игр бот считывает вероятность на вашем аккаунте, эти игры <u>являются балансировочными</u>, так как боту нужно самостоятельно адаптировать код. Далее он начинает приносить правильные прогнозы.</b>‼️

<b>P.s Делитесь результатами выигрышей с нами, самые большие опубликуем💸.</b>
🔗 @supporw1n
""",
